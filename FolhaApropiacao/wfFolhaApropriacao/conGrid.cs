      ...
      //  string tipoMenu;
        ...
        public bool Save(string date, decimal teamId, decimal areaId, decimal grupoId)       
        {
            ...
            if (tabelaNeg.verifyDataBase() == true)
            {
                ...
                DataTable dataTable = tabelaNeg.ListCraftLeaderSupervisorID(teamId);
                try
                {
        ...
        public void DataSourceLineOne(string id, string description, string specialSituation)
        {
        ...
        public bool DataSourceFill(DataTable dataTable, decimal team_id, string date)
        {
            ...
            if (dataTable.Rows.Count != 0)
            {
                ...
                try
                {
                    ...
                    {
                        DataSourceLineOne(dataTableCraft.Rows[cnt][0].ToString(), dataTableCraft.Rows[cnt][1].ToString(), "");
