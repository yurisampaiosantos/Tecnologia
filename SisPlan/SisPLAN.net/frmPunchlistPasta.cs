...
{
    public partial class frmPunchlistPasta : Form
    {
        ...
        //===================================================================================
        public frmPunchlistPasta()
        {
            InitializeComponent();
        }
        //===================================================================================
        private void frmPunchlistPasta_Load(object sender, EventArgs e)
        {
        ...
        {
            string sRet = @"1 = 1";
            if (cmbPasta.SelectedIndex > 0) sRet += @" AND X.PASTA_CODIGO = '" + cmbPasta.SelectedValue + "'";
        ...
        private void ShowReport(string filter)
        {
            ...
            report.ReportPath = systemRepository + @"RDLC\rdlcPunchlistPasta.rdlc";

            DTO.CollectionVwCpPunchlistDTO ca = new DTO.CollectionVwCpPunchlistDTO();
            ca = BLL.VwCpPunchlistBLL.GetCollection(filter, "X.PUNCH_ID DESC");
            ReportDataSource rds = new ReportDataSource("dsPunchlistPasta", ca);
