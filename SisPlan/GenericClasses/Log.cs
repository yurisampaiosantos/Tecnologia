...
namespace GenericClasses
{
    ...
    {
        //======================================================================
        public static void SaveLog(StreamWriter log, DTO.ProjTubHistoryDTO H)
        {
            log.WriteLine(H.ProcessHistory);
            log.Flush();
            BLL.ProjTubHistoryBLL.Insert(H, false);
        }
        //======================================================================
