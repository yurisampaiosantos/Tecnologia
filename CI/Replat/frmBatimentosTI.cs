...
namespace Replat
{
    public partial class frmBatimentosTI : Form
    {
        ...
        private void btGerar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dtConsulta = RfNfEntradaBLL.Select("SELECT * FROM RF_PRODUCAO_BAT WHERE TIPO_TRANS = 'TI'");
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (myDialogResult == DialogResult.Yes)
                    {
                        ...
                        MessageBox.Show("Alta de Produto Acabado (TI) Disponíveis no IN-OUT", "SUCESSO", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                }
