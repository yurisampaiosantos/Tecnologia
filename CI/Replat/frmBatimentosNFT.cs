...
namespace Replat
{
    public partial class frmBatimentosNFT : Form
    {
        public frmBatimentosNFT()
        {
            InitializeComponent();
        }
        ...
        {
            return @"SELECT 
                        COD_FORNECEDOR, DATA, DATA_GER_LEG, DOC_CONTROLE, NF_T, NUM_ITEM, ORGANIZACAO, PART_NUMBER, PROCEDENCIA_INFO, QTDE, SEGMENTO1, SEGMENTO2, SEGMENTO3, SEGMENTO4, SEGMENTO5, SERIE_T, TIPO_DESTINACAO, TIPO_NF, VALOR_FISCAL, CFOP, REF_ERP_ENT
                     FROM 
                        RF_NF_TRANSF_TERC_BAT";
        }

        public string SQL_REPLAT()
        {
            return @"SELECT 
                        ALERTA, COD_FORNECEDOR, DATA, DATA_GER_LEG, DOC_CONTROLE, ID_CORPORATIVO, NF_T, NUM_ITEM, ORGANIZACAO, PART_NUMBER, PROCEDENCIA_INFO, QTDE, SEGMENTO1, SEGMENTO2, SEGMENTO3, SEGMENTO4, SEGMENTO5, SERIE_T, TIPO_DESTINACAO, TIPO_NF, VALOR_FISCAL, CFOP, REF_ERP_ENT
                     FROM 
                        V_NFT_BATIMENTO_REPLAT";
        }

        public string SQL_SISEPC()
        {
            return @"SELECT 
                        ALERTA, ID_IMPORTACAO, COD_FORNECEDOR, NF_T, SERIE_T, DATA, DATA_GER_LEG, DOC_CONTROLE, NUM_ITEM, ORGANIZACAO, PART_NUMBER, PROCEDENCIA_INFO, QTDE, SEGMENTO1, SEGMENTO2, SEGMENTO3, SEGMENTO4, SEGMENTO5, TIPO_DESTINACAO, TIPO_NF, VALOR_FISCAL, CFOP, REF_ERP_ENT
                     FROM 
                        V_NFT_BATIMENTO_SISEPC";
        }
        ...
        private void btQuery_Click(object sender, EventArgs e)
        {
            ...
            frm.strQuery = @"SELECT 
PAR.COD_PARCEIRO COD_FORNECEDOR,
TO_CHAR(N.DATA,'yyyymmdd') DATA,
TO_CHAR(I.DATA_GER_LEG, 'yyyymmdd') DATA_GER_LEG,
I.DOC_CONTROLE,
N.NF NF_T,
I.NUM_ITEM_NF_TRANSF NUM_ITEM,
O.NOME ORGANIZACAO,
P.PART_NUMBER,
I.PROCEDENCIA_INFO,
I.QTDE,
...
I.CF_OP CFOP,
N.REF_ERP_ENT 
FROM RC_NF_TRANSF N, ITENS_NF_TRANSF I, SFW_PRODUTO P, SFW_ORGANIZACAO O, SFW_PARCEIRO PAR
WHERE N.ID_NF_TRANS = I.ID_NF_TRANS
AND I.ID_PRODUTO = P.ID_PRODUTO
AND P.ID_ORGANIZACAO = O.ID_ORGANIZACAO
AND N.ID_FORNECEDOR = PAR.ID_PARCEIRO
AND I.CANCELA = 'N'";
        ...
        private void btAbrir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (openFileDialog1.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                {
                    ...
                    string strTbl = "RF_NF_TRANSF_TERC_BAT";
