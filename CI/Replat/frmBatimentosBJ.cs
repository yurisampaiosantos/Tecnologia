...
namespace Replat
{
    public partial class frmBatimentosBJ : Form
    {
        ...
        private void btGerar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dtConsulta = RfNfEntradaBLL.Select("SELECT * FROM RF_MOVIMENTACOES_BAT WHERE TIPO_TRANS = 'BJ'");
