...
namespace Replat
{
    public partial class frmParceirosCad : Form
    {
        string quebraLinha = Environment.NewLine;

        public frmParceirosCad()
        {
            InitializeComponent();
        }
        ...
        public DataTable CarregaSQL()
        {
            string SQL = @"SELECT 
                                *
                            FROM 
                                V_AREA_ESTOCAGEM_REPLAT
                            WHERE
                                    COD_PARCEIRO IS NULL
                                AND LOCAL = 'E'";
        ...
        private void btExportar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    WorkSheet.Cells[1, 1] = "Parceiros não Cadastrados";
                    WorkSheet.Cells[2, 1].Select();
                    WorkSheet.Name = "Parceiros não Cadastrados";
