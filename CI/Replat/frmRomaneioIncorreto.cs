...
namespace Replat
{
    public partial class frmRomaneioIncorreto : Form
    {
        string quebraLinha = Environment.NewLine;

        public frmRomaneioIncorreto()
        {
            InitializeComponent();
        }
        ...
        private void btExportar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    WorkSheet.Cells[1, 1] = "Romaneios com dados Incompletos";
                    WorkSheet.Cells[2, 1].Select();
                    WorkSheet.Name = "Romaneios Incompletos";
