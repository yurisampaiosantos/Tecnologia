...
namespace Replat
{
    public partial class frmProdNcmPeso : Form
    {
        string quebraLinha = Environment.NewLine;

        public frmProdNcmPeso()
        {
            InitializeComponent();
        }
        ...
        private void btGerar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (gvImportacao[2, o].Value.ToString() == "")
                    {
                        qtdeSemNCM += 1;
                    }
                }
                ...
                for (int o = 0; o < gvImportacao.Rows.Count; o++)
                {
                    if (gvImportacao[4, o].Value.ToString() == "0")
                    {
                        qtdeSemPeso += 1;
                    }
                }
                ...
                lblNCM.Text = "Sem NCM: " + qtdeSemNCM;
                lblPeso.Text = "Sem Peso: " + qtdeSemPeso;
