...
namespace Replat
{
    public partial class frmBatimentosBF : Form
    {
        ...
        private void btGerar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dtConsulta = RfNfEntradaBLL.Select("SELECT * FROM RF_MOVIMENTACOES_BAT WHERE TIPO_TRANS = 'BF'");
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (myDialogResult == DialogResult.Yes)
                    {
                        ...
                        MessageBox.Show("Transferências Internas (QL) Disponíveis no IN-OUT", "SUCESSO", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                }
