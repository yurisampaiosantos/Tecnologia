...
namespace Replat
{
    public partial class frmBatimentosQK : Form
    {
        ...
        private void btGerar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dtConsulta = RfNfEntradaBLL.Select("SELECT * FROM RF_MOVIMENTACOES_BAT WHERE TIPO_TRANS = 'QK'");
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (myDialogResult == DialogResult.Yes)
                    {
                        ...
                        MessageBox.Show("Transferência Terceiro (QK) Disponíveis no IN-OUT", "SUCESSO", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                }
