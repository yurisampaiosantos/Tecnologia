...
namespace Replat
{
    public partial class frmTransfExternas : Form
    {
        string quebraLinha = Environment.NewLine;

        public frmTransfExternas()
        {
            InitializeComponent();
        }
        ...
        private void btExportar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    WorkSheet.Cells[1, 1] = "Transferências de Estoque Externas";
                    WorkSheet.Cells[2, 1].Select();
                    WorkSheet.Name = "Transferências Externas";
