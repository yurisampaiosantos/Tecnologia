...
{
    public partial class frmImpNovos : Form
    {
        public frmImpNovos()
        {
            InitializeComponent();
                ...
                else
                {
                    ...
                    if (myDialogResult == DialogResult.Yes)
                    {
                        ...
                        for (int i = 0; i < gvImportacao.Rows.Count; i++)
                        {
                            ...
                            string strNome = gvImportacao.Rows[i].Cells[1].Value.ToString().Replace("'", "");
                            string strFuncao = gvImportacao.Rows[i].Cells[2].Value.ToString().Replace("'", "");
