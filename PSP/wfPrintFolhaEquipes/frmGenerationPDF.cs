...
namespace wfPrintFolhaEquipes
{
    public partial class frmGenerationPDF : Form
    {
        ...
        private void frmGenerationPDF_Load(object sender, EventArgs e)
        {
            ...
            //DataTable dtEquipes = tabelaNeg.GetTeamByTeamId(rpId);
            ...
            DataTable dtEquipes = tabelaNeg.GetTeamByRpID(rpId);
            ListEquipesBindingSource.DataSource = tabelaNeg.GetTeamByRpID(rpId);
            ...
            reportParams.Add(new ReportParameter("data", Convert.ToDateTime(date).ToString("dd/MM/yyyy")));
            grupo = dtEquipes.Rows[0]["GROUP_TEAM_DESCRIPTION"].ToString();
            reportParams.Add(new ReportParameter("grupo", grupo));
            rp = dtEquipes.Rows[0]["RP_DESCRIPTION"].ToString();
            ...
            if (preImpresso == false)
            {
                ...
                reportViewer1.LocalReport.DataSources.Add(new ReportDataSource("dsEquipes", tabelaNeg.GetTeamByRpID(rpId)));
